...
from superduperoctofiesta.data import ReadData
import pandas as pd
        ...
        for well_num in self.wa_num:
            ...
            if (len(well_df) < 60):
                ...
                if (iptotal < 0.0001):
                    ...
                    df_ip['IP30'] = well_df.head(1 + startindex)['boe'].values[-1]
                    df_ip['IP60'] = well_df.head(2 + startindex)['boe'].values[-1]
                    df_ip['IP90'] = well_df.head(3 + startindex)['boe'].values[-1]
                    df_ip['IP120'] = well_df.head(4 + startindex)['boe'].values[-1]
                    df_ip['IP150'] = well_df.head(5 + startindex)['boe'].values[-1]
                    df_ip['IP180'] = well_df.head(6 + startindex)['boe'].values[-1]
                    df_ip['IP210'] = well_df.head(7 + startindex)['boe'].values[-1]
                    df_ip['IP240'] = well_df.head(8 + startindex)['boe'].values[-1]
                    df_ip['IP270'] = well_df.head(9 + startindex)['boe'].values[-1]
                    df_ip['IP300'] = well_df.head(10 + startindex)['boe'].values[-1]
                    df_ip['IP330'] = well_df.head(11 + startindex)['boe'].values[-1]
                    df_ip['IP360'] = well_df.head(12 + startindex)['boe'].values[-1]
                    df_ip['IP390'] = well_df.head(13 + startindex)['boe'].values[-1]
                    df_ip['IP420'] = well_df.head(14 + startindex)['boe'].values[-1]
                    df_ip['IP450'] = well_df.head(15 + startindex)['boe'].values[-1]
                    df_ip['IP480'] = well_df.head(16 + startindex)['boe'].values[-1]
                    df_ip['IP510'] = well_df.head(17 + startindex)['boe'].values[-1]
                    df_ip['IP540'] = well_df.head(18 + startindex)['boe'].values[-1]
                    df_ip['IP570'] = well_df.head(19 + startindex)['boe'].values[-1]
                    df_ip['IP600'] = well_df.head(20 + startindex)['boe'].values[-1]
                    df_ip['IP630'] = well_df.head(21 + startindex)['boe'].values[-1]
                    df_ip['IP660'] = well_df.head(22 + startindex)['boe'].values[-1]
                    df_ip['IP690'] = well_df.head(23 + startindex)['boe'].values[-1]
                    df_ip['IP720'] = well_df.head(24 + startindex)['boe'].values[-1]
                    df_ip['IP750'] = well_df.head(25 + startindex)['boe'].values[-1]
                    df_ip['IP780'] = well_df.head(26 + startindex)['boe'].values[-1]
                    df_ip['IP810'] = well_df.head(27 + startindex)['boe'].values[-1]
                    df_ip['IP840'] = well_df.head(28 + startindex)['boe'].values[-1]
                    df_ip['IP870'] = well_df.head(29 + startindex)['boe'].values[-1]
                    df_ip['IP900'] = well_df.head(30 + startindex)['boe'].values[-1]
                    df_ip['IP930'] = well_df.head(31 + startindex)['boe'].values[-1]
                    df_ip['IP960'] = well_df.head(32 + startindex)['boe'].values[-1]
                    df_ip['IP990'] = well_df.head(33 + startindex)['boe'].values[-1]
                    df_ip['IP1020'] = well_df.head(34 + startindex)['boe'].values[-1]
                    df_ip['IP1050'] = well_df.head(35 + startindex)['boe'].values[-1]
                    df_ip['IP1080'] = well_df.head(36 + startindex)['boe'].values[-1]
                    df_ip['IP1110'] = well_df.head(37 + startindex)['boe'].values[-1]
                    df_ip['IP1140'] = well_df.head(38 + startindex)['boe'].values[-1]
                    df_ip['IP1170'] = well_df.head(39 + startindex)['boe'].values[-1]
                    df_ip['IP1200'] = well_df.head(40 + startindex)['boe'].values[-1]
                    df_ip['IP1230'] = well_df.head(41 + startindex)['boe'].values[-1]
                    df_ip['IP1260'] = well_df.head(42 + startindex)['boe'].values[-1]
                    df_ip['IP1290'] = well_df.head(43 + startindex)['boe'].values[-1]
                    df_ip['IP1320'] = well_df.head(44 + startindex)['boe'].values[-1]
                    df_ip['IP1350'] = well_df.head(45 + startindex)['boe'].values[-1]
                    df_ip['IP1380'] = well_df.head(46 + startindex)['boe'].values[-1]
                    df_ip['IP1410'] = well_df.head(47 + startindex)['boe'].values[-1]
                    df_ip['IP1440'] = well_df.head(48 + startindex)['boe'].values[-1]
                    df_ip['IP1470'] = well_df.head(49 + startindex)['boe'].values[-1]
                    df_ip['IP1500'] = well_df.head(50 + startindex)['boe'].values[-1]
                    df_ip['IP1530'] = well_df.head(51 + startindex)['boe'].values[-1]
                    df_ip['IP1560'] = well_df.head(52 + startindex)['boe'].values[-1]
                    df_ip['IP1590'] = well_df.head(53 + startindex)['boe'].values[-1]
                    df_ip['IP1620'] = well_df.head(54 + startindex)['boe'].values[-1]
                    df_ip['IP1650'] = well_df.head(55 + startindex)['boe'].values[-1]
                    df_ip['IP1680'] = well_df.head(56 + startindex)['boe'].values[-1]
                    df_ip['IP1710'] = well_df.head(57 + startindex)['boe'].values[-1]
                    df_ip['IP1740'] = well_df.head(58 + startindex)['boe'].values[-1]
                    df_ip['IP1770'] = well_df.head(59 + startindex)['boe'].values[-1]
                    df_ip['IP1800'] = well_df.head(60 + startindex)['boe'].values[-1]
